                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-md mx-auto bg-black/30 backdrop-blur-xl border border-white/10 p-8 rounded-3xl shadow-2xl">
                        <div className="text-center mb-8">
                            <i className="fas fa-cash-register text-royal-gold text-4xl mb-4 drop-shadow-md"></i>
                            <h2 className="text-3xl font-playfair font-bold text-white">POS Terminal</h2>
                            <p className="text-gray-300 mt-2">Staff Access Portal</p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            <div>
                                <InputLabel htmlFor="email" value="Staff Identifier" className="block text-gray-300 mb-2 font-medium" />
                                <TextInput
                                    id="email"
                                    type="email"
                                    name="email"
                                    ...
                                    placeholder="pos@indianroyaldine.co.uk"
                            ...
                            <div>
                                <InputLabel htmlFor="password" value="Access Password" className="block text-gray-300 mb-2 font-medium" />
                                <TextInput
                                    id="password"
                                    type="password"
                                    name="password"
                        ...
                        <div className="mt-8 text-center text-gray-400 text-sm">
                            <p>© {new Date().getFullYear()} Indian Royal Dine. POS System.</p>
                        </div>
                    </div>
                </div>
            </section>
